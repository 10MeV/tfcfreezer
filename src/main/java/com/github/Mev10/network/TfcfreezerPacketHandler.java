...
public class TfcfreezerPacketHandler {
    ...
    private static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(TfcfreezerHelpers.identifier("network"), () -> VERSION, VERSION::equals, VERSION::equals);
